    ...
    <div>
        ...
        {(error === 'server' || error === 'logout') && (
            <Message icon negative style={{ margin: '30px auto', maxWidth: '400px' }}>
                <Icon name='bug' />
                <Message.Content>
                <Message.Header>Our server seems to encounter some issues.</Message.Header>
                We are working on a fix which will probably include lowering the dice of death probability.
                </Message.Content>
            </Message>
        )}
    </div>
